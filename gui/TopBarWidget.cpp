...
TopBarWidget::TopBarWidget(QWidget* parent) : QWidget(parent)
{
	...
	connect(m_button_settings, &ScalableIconButton::clicked, this,
	        &TopBarWidget::SettingsToggleRequested);
	connect(m_button_history, &ScalableIconButton::clicked, this,
	        &TopBarWidget::HistoryToggleRequested);
